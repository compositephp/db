...
final class CompositeTableTest extends BaseTableTest
{
    ...
    {
        (new Tables\TestCompositeTable(self::getDatabaseManager()))->init();
        (new Tables\TestCompositeSdTable(self::getDatabaseManager()))->init();
    }
    ...
    public function crud_dataProvider(): array
    {
        return [
            ...
            [
                new Tables\TestCompositeCachedTable(self::getDatabaseManager(), self::getCache()),
                Entities\TestCompositeEntity::class,
            ],
            [
                new Tables\TestCompositeSdCachedTable(self::getDatabaseManager(), self::getCache()),
                Entities\TestCompositeSdEntity::class,
            ],
        ];
    }
